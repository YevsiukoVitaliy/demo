  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "https://nodejsclusters-115724-0.cloudclusters.net/auth/google/callback",
    },
  ...
  new MicrosoftStrategy(
    {
      ...
      callbackURL: "https://nodejsclusters-115724-0.cloudclusters.net/auth/microsoft/callback",
      scope: ['user.read'],
    },
    async (accessToken, refreshToken, profile, done) => { 
      const email = profile.emails[0].value;
  ...
  new FacebookStrategy(
    {
      ...
      callbackURL: "https://nodejsclusters-115724-0.cloudclusters.net/auth/facebook/callback",
    },
    async (accessToken, refreshToken, profile, done) => {
      const email = profile.emails[0].value;
